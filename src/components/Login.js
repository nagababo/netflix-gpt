...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className='w-3/12 absolute p-12 bg-black my-30 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80'>
        ...
        <button className='bg-red-700 w-full p-4 my-4 rounded-lg cursor-pointer'>{isSignInForm ? "Sign In" : "Sign Up"}</button>
